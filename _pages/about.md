...
I am currently a first-year PhD student in system engineering at [CUHK](https://www.cuhk.edu.hk/) under the supervision of [Prof. Xixin Wu](https://www1.se.cuhk.edu.hk/~wuxx/). Previously, I received an MPhil AI degree from [HKUST(GZ)](https://www.hkust-gz.edu.cn/), under the supervision of [Prof. Li Liu](https://liliu-avril.github.io/) and the co-supervision of [Prof. Yi R. (May) Fung](https://mayrfung.github.io/), plus an MSc CS degree from [HKU](https://www.hku.hk/). Between the two master's studies, I worked as an RA at [ASTAPLE](https://www.astaple.com/) of [PolyU](https://www.polyu.edu.hk/) with [Prof. Haibo Hu](https://haibohu.org/). I got my BEng degree in software engineering at [ECNU](https://english.ecnu.edu.cn/), where I began my research career under the supervision of [Prof. Dehui Du](https://scholar.google.com/citations?user=9WHLtvoAAAAJ&hl=en&oi=ao). It is also my great pleasure to work with close co-authors [Zi Liang](https://liangzid.github.io/research.html) (PolyU), [Ziyu Zhou](https://zhouziyu.com/) (HKUST), [Yu Huang](https://hardenyu21.github.io/) (CityU), [Yiming Huang](https://scholar.google.com/citations?user=E4Blpr8AAAAJ&hl=en) (HKUST), [Weilin Lin](https://linweiii.github.io/) (HKUST(GZ)), and [Nanjun Zhou](https://quantum-bitss.github.io/) (ZJU).

My research interests include AI Security and Multimodal Large Language Models. Specifically, I used to study adversarial attacks and defenses across time series, vision, and speech. Together with close co-authors, I have also dabbled in model extraction, backdoor, data poisoning, agent security, etc. Recently, I have been interested in MLLM post-training and inference-time security, especially regarding safety alignment and modality gap under multimodal inputs. 
...
- <img src="images/Icon_PingAn.png" width="69" height="23"/> *2021.08 - 2021.11*, NLP Algorithm Intern, [Ping An Technology](https://tech.pingan.com/), Shanghai.
- <img src="images/Icon_Dareway.png" width="57" height="19"/> *2020.07 - 2020.08*, Software Development Intern, [Dareway Intelligent Technology](https://www.dareway.cn/#/), Jinan.
